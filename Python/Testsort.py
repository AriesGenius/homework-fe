...
# list to store printed statements
output_array = []
...
# Append the printed statements to the output_array
output_array.append("The relationships are " + str(relationships))
output_array.append("The x coordinates are: " + str(xCoordinate))
output_array.append("The y coordinates are: " + str(yCoordinate))
output_array.append("The w coordinates are: " + str(wCoordinate))
output_array.append("The h coordinates are: " + str(hCoordinate))
output_array.append("The classes are: " + str(newClasses))
output_array.append("The m1's are: " + str(m1))
output_array.append("The m2's are: " + str(m2))
output_array.append("The attributes are: " + str(attributesList))
output_array.append("The attributes are: " + str(newAttributesList))
output_array.append("The methods are: " + str(methodsList))
output_array.append("attribute count list: " + str(attributeCountList))
output_array.append("method count list: " + str(methodCountList))
output_array.append("the attribute visibilities are: " + str(attributeVis))
output_array.append("the attribute types are: " + str(attributeTypes))
output_array.append("the labels are: " + str(labels))
output_array.append("relationship labels level: " + str(relationLevel))

# ... (rest of your code)

# Now you can print the output_array
